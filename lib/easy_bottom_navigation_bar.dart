library easy_bottom_navigation_bar;

import 'package:easy_bottom_navigation_bar/src/EasyNavigationBarItem.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class EastBottomNavigationBar extends StatefulWidget {
  EastBottomNavigationBar(
      {@required this.items,
  ...
  @override
  _EastBottomNavigationBar createState() => _EastBottomNavigationBar();
}

class _EastBottomNavigationBar extends State<EastBottomNavigationBar>
    with TickerProviderStateMixin<EastBottomNavigationBar> {
  double width = 0;
